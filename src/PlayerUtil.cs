    ...
    public static class PlayerUtil
    {
        ...
        public static void DefineParticle(Player p, byte id, LuaTable particle)
        {
            p.Send(Packet.DefineEffect(
                            ...
                            (byte)(Convert.ToInt32(particle["x"]) + Convert.ToInt32(particle["width"]) - 1),
                            (byte)(Convert.ToInt32(particle["y"]) + Convert.ToInt32(particle["height"]) - 1),
                            ...
                            Convert.ToSingle(particle["sizeVariation"]),
                            Convert.ToSingle(particle["spread"]),
                            Convert.ToSingle(particle["speed"]),
                            Convert.ToSingle(particle["gravity"]),
                            Convert.ToSingle(particle["lifetime"]),
                            Convert.ToSingle(particle["lifetimeVariation"]),
